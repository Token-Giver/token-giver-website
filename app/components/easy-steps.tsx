...
function EasySteps() {
  ...
  return (
    <div className='py-[90px] px-[24px] sm:px-[40px] lg:px-[100px]'>
      ...
      <div
        onClick={toggleTab}
        className='relative flex w-fit gap-x-[10px] text-lg leading-6 cursor-pointer items-center rounded-full bg-[#F0F0F0] p-[10px] transition-colors duration-300 mx-auto'
      >
        <div
