...
function StepBlock({ step }: { step: Step }) {
  return (
    ...
    >
      ...
      <div className={` md:hidden flex gap-x-[10px]  items-center`}>
      ...
      <div className='relative max-md:order-3 font-AgrandirBold text-black text-lg leading-8 flex-1 flex justify-center items-center  max-w-[547px] max-h-[555px]'>
        <img
          src={step.illus}
