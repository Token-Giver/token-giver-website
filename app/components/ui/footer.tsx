...
function Footer() {
  return (
    <div>
      <div className="lg:pb-[40px] lg:px-[100px] px-6 pb-7">
        <div className="pt-6 lg:pt-10 border-t-[.8px] border-t-[#D9D9D9] w-full flex lg:flex-row flex-col items-start lg:justify-between gap-y-3">
          <div className="lg:max-w-[448px]">
            <img src="/logo.svg" alt="" />
            <p className="font-medium text-sm lg:text-base text-ash">
              Token Giver welcomes you to a platform built on trust,
              transparency, and impact. Let&apos;s give smarter, together.
            </p>
          </div>
          <div className="flex lg:gap-x-[109px] flex-wrap lg:flex-nowrap gap-y-4 gap-x-[70px]">
            <div>
              <h5 className="mb-4 lg:mb-[30px] font-semibold text-base text-[#121212]">
                Company
              </h5>
      ...
      <div className="bg-raisin-black py-4 lg:py-[30px] px-6 lg:px-[100px] flex lg:flex-row flex-col lg:justify-between text-white gap-y-4">
        ...
        <div className="flex lg:flex-row flex-col items-start lg:items-center lg:gap-x-[62px] gap-y-3">
