...
function ContributionStats() {
  ...
  return (
    <div className="px-6 sm:px-10 lg:px-[100px] md:py-10 2xl:max-w-[1440px] 2xl:mx-auto">
      <div className=" ">
        <h3 className="text-center font-AgrandirBold text-xl  sm:text-3xl text-primary">
          {totalContributions}
        </h3>
        <p className="text-sm text-center sm:text-base leading-8 text-raisin-black font-medium mb-3 md:mb-6">
          Contributions members done since 2024
        </p>
      </div>
      <div className="flex h-5 md:h-8 gap-x-1 md:gap-x-2 mb-2 md:mb-4">
        <div
      ...
      <div className="flex flex-col pt-3 gap-2  md:gap-4 md:flex-row   md:justify-between">
        <div>
          <h4 className="font-AgrandirBold text-base md:text-xl  text-primary">
            {totalDonations}
          </h4>
        ...
        <div className="md:text-right">
          <h4 className="font-AgrandirBold text-base md:text-xl text-jonquil">
            {totalCampaigns}
          </h4>
          <p className="text-sm md:text-base leading-8 text-raisin-black font-medium">
