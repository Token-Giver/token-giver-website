...
function BlogSection() {
  return (
    <div className="py-5 md:py-10 px-6 sm:px-10 lg:px-20 xl:px-[100px] 2xl:max-w-[1440px] 2xl:mx-auto">
      <div className=" flex flex-col gap-2 md:gap-4">
        ...
        <p className="font-medium text-sm leading-7 sm:text-base md:leading-8 text-ash mb-8 max-w-[624px]">
