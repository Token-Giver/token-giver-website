    ...
    <div className="text-center pt-[140px] md:pt-[180px] pb-10 flex flex-col items-center  md:px-10 lg:px-20 xl:px-[100px] 2xl:max-w-[1440px] 2xl:mx-auto">
      ...
      <div className="w-full relative mt-[-12px]">
        ...
        <div className="px-6 md:px-[57px] pt-8">
          <p className=" text-sm leading-7 sm:text-base text-ash md:leading-[35px] mb-7">
          ...
          <div className="flex flex-col sm:flex-row gap-4  justify-center items-center md:gap-x-3">
            <button className="py-3 px-[47px] md:py-4 rounded-full w-full md:w-[250px] bg-primary font-semibold text-sm leading-[23px] text-white">
              Start a Campaign
            </button>
            <button className="bg-white py-3 md:py-4 rounded-full w-full md:w-[250px] text-primary border-primary border font-semibold text-sm">
              Explore Categories
            </button>
          </div>
        </div>
