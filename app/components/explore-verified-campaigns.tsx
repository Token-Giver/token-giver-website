...
function ExploreVerifiedCampaigns() {
  ...
  return (
    <div className="py-[80px] px-[100px]">
      ...
      <div className="overflow-scroll w-full flex gap-x-5 font-AgrandirBold">
        {campaignThemes.map((theme) => {
          let isActive = currentTheme === theme.name;
          return (
            <button
              key={theme.name}
              className={`capitalize w-fit flex items-center gap-x-3 justify-center py-3 px-[42px] hover:bg-primary hover:text-white rounded-full ${
                isActive
      ...
      <div className="flex justify-between gap-x-[42px] items-stretch mt-[85px] mb-[47px]">
        ...
        <div className="flex-1 max-w-[579px]">
          <h2 className="max-w-[454px] font-AgrandirBold text-2xl text-raisin-black mb-[10px]">
            Donations for the upcoming Inter-house Sports Competition
          </h2>
          <p className="text-base leading-8 text-ash mb-6">
          ...
          <div className="w-full h-[7px] bg-[#EFEFEF] rounded-full mb-6">
          ...
          <div className="flex gap-x-[98px]">
            <div className="flex flex-col gap-y-1">
              ...
              <h4 className="text-sm leading-6 text-[#A1A1A1] font-medium">
                Total Raised
              </h4>
            </div>
            <div className="flex flex-col gap-y-1">
          ...
          <button className="py-[11px] px-[30px] rounded-full text-base text-raisin-black font-semibold font-montserrat border-[1px] border-[#808080] mt-[25px]">
            Learn More
          </button>
        </div>
      </div>
